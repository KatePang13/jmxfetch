...
@Slf4j
public class TryRemoteConnection extends Connection {
    ...
    /** TryRemoteConnection constructor for specified remote connection parameters. */
    public TryRemoteConnection(Map<String, Object> connectionParams) throws IOException {
